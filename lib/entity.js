 ...
 * @param {Date} now The time to update.
 */
Entity.prototype.updateTouched = function(now) {
  this._touched = now;
};
...
Entity.prototype.clone = function() {
  var newClone = new Entity();
  if (this._path) {
    newClone._path = new sitepath(this._path);
  }
  newClone._entityId = this._entityId;
  newClone._revisionId = this._revisionId;
  newClone._revisionNum = this._revisionNum;
  newClone._proto = this._proto;
  newClone._modified = this._modified;
  newClone._created = this._created;
  newClone._touched = this._touched;
  newClone._hidden = this._hidden;
  newClone.summary = clone(this.summary);
  newClone.data = clone(this.data);
  newClone._tags = new LinkedDataBox(this._tags);
  newClone.permissions = clone(this.permissions);
  newClone.fullTextString = this.fullTextString;
  return newClone;
};
