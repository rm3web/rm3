...
move_entity_query = "UPDATE wh_entity SET (path, revision_id, revision_num)  = \
($2, $3, $4) WHERE path = $1;";
...
function RevisionIdNotFoundClass() {
  this.message = "revision_id not found";
}
util.inherits(RevisionIdNotFoundClass, Error);
errs.register('update.log_not_found', InvalidLogClass);
