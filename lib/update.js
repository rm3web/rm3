...
function postCommitErr(db, client, err, done, next) {
...
function doCleanup(db, next, err, client, done, logentry) {
  if (err) {
    return postCommitErr(db, client, err, done, next);
  }
  done(err);
...
*/
exports.createEntity = function(db, entity, exec, note, next) {
  async.waterfall([
    db.connectWrap,
    db.openTransaction,
...
/**
  ...
  @param {*} next Function that takes(err, entityId, revision_id, revision_num)
*/
exports.updateEntity = function(db, oldEntity, newEntity, exec, note, next) {
  async.waterfall([
    db.connectWrap,
    db.openTransaction,
    function generateLogentry(client, done, callback) {
...
/**
  ...
  @param {*} next Function that takes(err, entityId, revision_id, revision_num)
*/
exports.commitEntityRev = function(db, revisionId, next) {
  async.waterfall([
    db.connectWrap,
    db.openTransaction,
...
/**
  ...
  @param {*} next Function that takes(err, entityId, revision_id, revision_num)
*/
exports.moveEntity = function(db, entity, newPath, exec, note, next) {
  async.waterfall([
    db.connectWrap,
    db.openTransaction,
    function generateLogentry(client, done, callback) {
...
/**
  ...
  @param {*} next Function that takes(err, entityId, revision_id, revision_num)
*/
exports.deleteEntity = function(db, entity, exec, note, next) {
  async.waterfall([
    db.connectWrap,
    db.openTransaction,
    function generateLogentry(client, done, callback) {
...
exports.assignUserToRole = function(db, userpath, role, note, next) {
  async.waterfall([
    db.connectWrap,
    db.openTransaction,
    function generateLogentry(client, done, callback) {
...
exports.removeUserFromRole = function (db, userpath, role, note, next) {
  async.waterfall([
    db.connectWrap,
    db.openTransaction,
    function generateLogentry(client, done, callback) {
...
exports.addPermissionToRole = function(db, role, permission, path, note, next) {
  async.waterfall([
    db.connectWrap,
    db.openTransaction,
    function generateLogentry(client, done, callback) {
...
exports.removePermissionFromRole = function (db, role, permission, path, note, next) {
  async.waterfall([
    db.connectWrap,
    db.openTransaction,
    function generateLogentry(client, done, callback) {
