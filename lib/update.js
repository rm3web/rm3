...
function writeLogentry(ctx, client, done, logentry, callback) {
...
function updateLogentry(ctx, client, done, logentry, callback) {
...
function execLogentry(ctx, exec, client, done, logentry, callback) {
...
function clearTags(ctx, exec, client, done, logentry, callback) {
...
function writeTags(ctx, exec, client, done, logentry, callback) {
