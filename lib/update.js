  ...
  async.waterfall([
    ...
    function generate_logentry(client, done, callback) {
      ...
      var logentry = {
        ...
        evtFinal: false,
        data: {
          fromData: old_entity.to_log(entityId),
          toData: new_entity.to_log(entityId)
        }
      };
      callback(null, client, done, logentry);
    },
  ...
  async.waterfall([
    ...
    function generate_logentry(client, done, callback) {
      ...
      var logentry = {
        ...
        evtFinal: false,
        data: {
          fromData: entity.to_log(entity._entityId),
  ...
  async.waterfall([
    ...
    function generate_logentry(client, done, callback) {
      ...
      var logentry = {
        ...
        evtFinal: false,
        data: {
          fromData: entity.to_log(entityId)
        }
      };
      callback(null, client, done, logentry);
    },
