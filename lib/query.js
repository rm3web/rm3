...
exports._queryGen = function(access, curpath, select, target, filter, sort, facet, pagination) {
  ...
  if (filter.hasOwnProperty('navbar') || filter.hasOwnProperty('predicate') || filter.hasOwnProperty('predicates') || filter.hasOwnProperty('comment') || filter.hasOwnProperty('tag')) {
