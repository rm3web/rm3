...
exports = module.exports = function(sessionRedisClient) {
  ...
  return function addContext(req, res, next) {
    req.rateLimiter = {};
    req.rateLimiter.userLimiter = limiterFunction.bind(this,'userLimiter');
    req.rateLimiter.ipLimiter = limiterFunction.bind(this,'ipLimiter');
    req.rateLimiter.emailLimiter = limiterFunction.bind(this,'emailLimiter');
    req.rateLimiter.csrfEmailLimiter = limiterFunction.bind(this,'csrfEmailLimiter');
    req.rateLimiter.csrfLimiter = limiterFunction.bind(this,'csrfLimiter');
