...
var Page = function () {
	...
	this.command_router.addRoute('/GET/delete', function(req, res, page, db, next)
	{
	...
	this.command_router.addRoute('/GET/create', function(req, res, page, db, next)
	{
		var now = new Date();
	...
	this.view_router.addRoute('/GET/history', function(req, res, page, next) 
	{
		var view = req.entity.view();
