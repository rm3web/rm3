...
function PredicatePage() {
  ...
  this.createFunc = function(now, req, res, next) {
    ...
    formlib.copyViaDottedPath(req.entity, req.body, PredicateForm.entityToForm);
  ...
  this.exposeFunc = function(editData, req, res, next) {
    formlib.copyViaDottedPath(editData, req.entity, PredicateForm.formToEntity);
  ...
  this.viewRouter.get('', view.basicViewWithJsonView.bind(this, undefined, 'view-predicate'));
}
