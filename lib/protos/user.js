...
function UserPage() {
  ...
  this.exposeFunc = function(req, res, next) {
    var editData = {
      username: req.sitepath.leaf(),
      path: req.sitepath.toDottedPath(),
      fullname: req.entity.summary.title,
      profileUrl: req.entity.summary.profileUrl,
      email: req.entity.data.email,
      profileText: req.entity.summary.abstract,
      disableLogin: req.entity.data.disableLogin
    };
