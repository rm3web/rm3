...
function DeletableMixin(page) {
  page.command_router.route_all('delete', authorize({requiresAuth: true, permission: "delete"}));

  page.command_router.get('delete', function(req, res, next)
  {
  ...
  page.view_router.route_all('delete', function(req, res, next) 
  {
...
function BaseBehaviorMixin(page) {
  page.command_router.route_all('edit', authorize({requiresAuth: true, permission: 'edit'}));
  page.command_router.route_all('create', authorize({requiresAuth: true, effectivePermission: 'edit'}));
  page.command_router.route_all('tag', authorize({requiresAuth: true, effectivePermission: 'edit'}));

  page.command_router.post('tag', function(req, res, next)
  {
  ...
  page.command_router.post('edit', function(req, res, next)
  {
    var oldent = req.entity.clone();
  ...
  page.command_router.get('create', function(req, res, next)
  {
    var now = new Date();
    req.entity.createNew(req.sitepath.down(req.body.path), req.page.proto, now);
    next();
  });
  page.command_router.post('create', function(req, res, next)
  {
    var now = new Date();
  ...
  page.view_router.route_all('edit', basic_view.bind(this, 'edit', 'edit'));
  page.view_router.route_all('create', basic_view.bind(this, 'create', 'create'));
  page.view_router.route_all('tag', basic_view.bind(this, 'tag', 'tag'));
}


function HistoryViewMixin(page) {
  page.view_router.get('history', basic_view.bind(this, 'history', 'history'));
}
...
function UserPage() {
  ...
  this.command_router.route_all('edit', authorize({requiresAuth: true, permission: 'edit'}));
  this.command_router.route_all('create', authorize({requiresAuth: true, effectivePermission: 'edit'}));

  this.command_router.post('edit', function(req, res, next)
  {
    var oldent = req.entity.clone();
  ...
  this.command_router.post('create', function(req, res, next)
  {
    var now = new Date();
  ...
  this.view_router.route_all('edit', basic_view.bind(this, 'edit', 'edit-user'));
  this.view_router.route_all('create', basic_view.bind(this, 'create', 'edit-user'));
}
