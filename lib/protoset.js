...
function BaseBehaviorMixin(page) {
  ...
  page.view_router.route_all('edit', function(req, res, next) 
  {
    var view = req.entity.view();
    view.user = req.user;
    view.error_message = req.flash('error');
    view.info_message = req.flash('info');
    view.section = 'edit';
    req.scheme.render('edit', view, req.page._renderPageResponse.bind(this, req, res));
  });
  page.view_router.route_all('create', function(req, res, next) 
  {
    var view = req.entity.view();
    view.user = req.user;
    view.error_message = req.flash('error');
    ...
    req.scheme.render('create', view, req.page._renderPageResponse.bind(this, req, res));
  });
...
function HistoryViewMixin(page) {
  page.view_router.get('history', function(req, res, next) 
  {
    var view = req.entity.view();
    view.error_message = req.flash('error');
    view.info_message = req.flash('info');
    view.section = 'history';
    req.scheme.render('history', view, req.page._renderPageResponse.bind(this, req, res));
  });
}
...
function TempIndexClass() {
  BasePage.call(this);
  this.proto = 'index';
  this.view_router.get('', function(req, res, next) 
  {
    var view = req.entity.view();
    view.user = req.user;
    view.error_message = req.flash('error');
    view.info_message = req.flash('info');
    req.scheme.render('index', view, req.page._renderPageResponse.bind(this, req, res));
  });
}
...
function UserPage() {
  ...
  this.view_router.get('', function(req, res, next) 
  {
    ...
    view.error_message = req.flash('error');
    view.info_message = req.flash('info');
    req.scheme.render('view-user', view, req.page._renderPageResponse.bind(this, req, res));
  });
  this.view_router.route_all('edit', function(req, res, next) 
  {
    var view = req.entity.view();
    view.user = req.user;
    view.section = 'edit';
    ...
    req.scheme.render('edit-user', view, req.page._renderPageResponse.bind(this, req, res));
  });
  this.view_router.route_all('create', function(req, res, next) 
  {
    var view = req.entity.view();
    view.user = req.user;
    view.section = 'create';
