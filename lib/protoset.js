...
function DeletableMixin(page) {
  page.command_router.route_all('delete.html', authorize({requiresAuth: true, permission: "delete"}));

  page.command_router.get('delete.html', function(req, res, next)
  {
  ...
  page.view_router.route_all('delete.html', function(req, res, next) 
  {
...
function BaseBehaviorMixin(page) {
  page.command_router.route_all('edit.html', authorize({requiresAuth: true, permission: 'edit'}));
  page.command_router.route_all('create.html', authorize({requiresAuth: true, effectivePermission: 'edit'}));
  page.command_router.route_all('tag.html', authorize({requiresAuth: true, effectivePermission: 'edit'}));

  page.command_router.post('tag.html', function(req, res, next)
  {
  ...
  page.command_router.post('edit.html', function(req, res, next)
  {
    var oldent = req.entity.clone();
  ...
  page.command_router.get('create.html', function(req, res, next)
  {
    var now = new Date();
    req.entity.createNew(req.sitepath.down(req.body.path), req.page.proto, now);
    next();
  });
  page.command_router.post('create.html', function(req, res, next)
  {
    var now = new Date();
  ...
  page.view_router.route_all('edit.html', basic_view.bind(this, 'edit', 'edit'));
  page.view_router.route_all('create.html', basic_view.bind(this, 'create', 'create'));
  page.view_router.route_all('tag.html', basic_view.bind(this, 'tag', 'tag'));
}


function HistoryViewMixin(page) {
  page.view_router.get('history.html', basic_view.bind(this, 'history', 'history'));
}
...
function BasePage() {
  ...
  this.view_router.get('', basic_view.bind(this,undefined, 'view'));
}
...
function TempIndexClass() {
  ...
  this.view_router.get('', basic_view.bind(this,undefined, 'index'));
}
...
function UserPage() {
  ...
  this.command_router.route_all('edit.html', authorize({requiresAuth: true, permission: 'edit'}));
  this.command_router.route_all('create.html', authorize({requiresAuth: true, effectivePermission: 'edit'}));

  this.command_router.post('edit.html', function(req, res, next)
  {
    var oldent = req.entity.clone();
  ...
  this.command_router.post('create.html', function(req, res, next)
  {
    var now = new Date();
  ...
  this.view_router.get('', basic_view.bind(this,undefined, 'view-user'));
  this.view_router.route_all('edit.html', basic_view.bind(this, 'edit', 'edit-user'));
  this.view_router.route_all('create.html', basic_view.bind(this, 'create', 'edit-user'));
}
