...
var Conf = function() {
  this._data = {};
  this._data.config = {};
  this._data.config.runInterval = process.env.RM3_WF_RUN_INTERVAL || 5000;
  this._data.config.workflowDisable = process.env.RM3_WF_DISABLE || false;
  ...
  this._data.config.jwtExpiresSeconds = process.env.RM3_JWT_EXPIRES_SECONDS || (24 * 60 * 60);
  ...
  this._data.path.privateBlobs = process.env.RM3_PRIVATE_BLOBS;
  ...
  this._data.certificates.jwtAudienceRoot = process.env.RM3_JWT_AUDIENCE_ROOT || '127.0.0.1';
