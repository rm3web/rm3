...
exports.passportConnect = function passportConnect(db, query, entity, userpath) {
  ...
  passport.use(new BearerStrategy(
    function(token, done) {
      boundLogger.info('bearerAuth', {
      });
      accessToken.validateAccessToken(jwtSecret, jwtIssuer, jwtExpiresSeconds, token, function(err, subject) {
        if (err) {
