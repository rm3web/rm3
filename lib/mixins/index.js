...
function CommentableMixin(page) {
  ...
  page.securityRouter.get('comment.cgi', authorize({effectivePermission: 'comment.create'}));
  page.securityRouter.post('comment.cgi', authorize({effectivePermission: 'comment.create'}));
  page.securityRouter.get('comment.js', authorize({effectivePermission: 'comment.create'}));
  ...
  page.commandRouter.post('comment.cgi', function(req, res, next) {
    res.format({
      'application/json': function() {
        ...
        var canPost = req.entity.permissions.hasOwnProperty('comment.create');
