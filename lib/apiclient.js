...
Page.prototype.toggleNavbar = function() {
  var req;
  req = superagent
    .post(this.base + this.page + 'togglenavbar.cgi')
    .send({})
    .accept('application/json');
  return req;
};

Page.prototype.toggleHidden = function() {
  var req;
  req = superagent
    .post(this.base + this.page + 'togglehidden.cgi')
    .send({})
    .accept('application/json');
  return req;
};
