...
var Scheme = function(schemepath, db, cache, query) {
  ...
  this._compileTemplate("edit-predicate.html", "edit-predicate");
  this._compileTemplate("edit-vectorgraphic.html", "edit-vectorgraphic");
